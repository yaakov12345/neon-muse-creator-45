            ...
            function: {
              ...
              parameters: {
                ...
                properties: {
                  ...
                  acquisitionVideoConcept: { type: "string", description: "Short TikTok video idea a creator can post to attract NEW USERS to this tool." },
                  acquisitionHook: { type: "string", description: "Controversial / emotional / curiosity hook designed for TikTok audience to drive user acquisition." },
                  problemToToolAngle: { type: "string", description: "How this content naturally leads viewers to want this app (problem → tool angle)." },
                  acquisitionScript: { type: "string", description: "Ready TikTok script that promotes the concept ORGANICALLY (not an ad). Plain text, multiple short lines." },
                  viralPostIdea: { type: "string", description: "A TikTok content idea that promotes this tool INDIRECTLY." },
                  acquisitionCtaLoop: { type: "string", description: "One sentence that makes viewers want to try the tool — soft, not salesy." },
                  viralSeed: { type: "string", description: "One curiosity-trigger sentence about the tool ('this was generated by an AI tool…')." },
                  acquisitionHashtags: {
                    type: "array",
                    minItems: 5,
                    maxItems: 5,
                    items: { type: "string" },
                    description: "5 viral TikTok hashtags for user acquisition.",
                  },
